...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "AI-native learning for Bangladesh. বোধ হোক।" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "অনুধাবন AI — Cognitive Flow Learning" },
      { name: "twitter:description", content: "AI-native learning for Bangladesh. বোধ হোক।" },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/d6780c26-1eea-4d36-a577-b64b769bdee3/id-preview-bbef9216--11348062-78f7-49a5-8e3f-5920df4d1ddc.lovable.app-1777387338922.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/d6780c26-1eea-4d36-a577-b64b769bdee3/id-preview-bbef9216--11348062-78f7-49a5-8e3f-5920df4d1ddc.lovable.app-1777387338922.png" },
    ],
    links: [
